...
/*        body: jsonEncode(<String, String>{
      ...
      print('_postRespostas - cheguei - passo 1,5 $jsonData');
      print('_postRespostas - cheguei - passo 2');
      List<RetRespostas> _listRespostas = [];
      int x = 0;
      print('_postRespostas - cheguei - passo 3');
      ...
      print('_postRespostas - cheguei - passo 4');
...
//    return _listPerguntas;
  ...
  _proximaPergunta(String pResposta) {
    ...
    if (_acertou != 99) {
      ...
      String _tempo = _counter.toString();
      String _resposta = _idResposta[_acertou];
      _postRespostas(_idPergunta, _resposta, _tempo);
      // {"metodo":"getrespostas","id_usuario":"1","id_pergunta":"1","id_resposta":"1","res_tempo":"00:30"
      ...
      print('Game Over!');
      //   setState() {
      print('cheguei no setState - showAlert');
      //_showAlertDialog(context, ' Resposta errada!');
      _showMyDialog(' Resposta errada!');
      print('cheguei no setState - deslogar');
      //
      //   }
    }
  }

/*  _showAlertDialog(BuildContext context, String pMensagem) {
    print('cheguei no showAlertDialog');
    Alert(
      context: context,
      // type: AlertType.warning,
      title: "FIM DE JOGO - " + pMensagem,
      actions: [
        DialogButton(
          child: Text(
            "OK",
